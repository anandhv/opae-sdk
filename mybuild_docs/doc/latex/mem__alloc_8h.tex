...
\item 
int \mbox{\hyperlink{mem__alloc_8h_a6918defbb1a2f52c74cc458eb8af157a}{mem\+\_\+alloc\+\_\+apply\+\_\+constraint}} (struct \mbox{\hyperlink{mem__alloc_8h_structmem__alloc}{mem\+\_\+alloc}} $\ast$m, struct \mbox{\hyperlink{mem__alloc_8h_structmem__alloc}{mem\+\_\+alloc}} $\ast$m\+\_\+constr)
\end{DoxyCompactItemize}
...
\end{DoxyCode}
 \mbox{\label{mem__alloc_8h_a6918defbb1a2f52c74cc458eb8af157a}} 
\index{mem\_alloc.h@{mem\_alloc.h}!mem\_alloc\_apply\_constraint@{mem\_alloc\_apply\_constraint}}
\index{mem\_alloc\_apply\_constraint@{mem\_alloc\_apply\_constraint}!mem\_alloc.h@{mem\_alloc.h}}
\doxysubsubsection{\texorpdfstring{mem\_alloc\_apply\_constraint()}{mem\_alloc\_apply\_constraint()}}
{\footnotesize\ttfamily int mem\+\_\+alloc\+\_\+apply\+\_\+constraint (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{mem__alloc_8h_structmem__alloc}{mem\+\_\+alloc}} $\ast$}]{m,  }\item[{struct \mbox{\hyperlink{mem__alloc_8h_structmem__alloc}{mem\+\_\+alloc}} $\ast$}]{m\+\_\+constr }\end{DoxyParamCaption})}

Apply free list constraints from a second allocator.

Apply the memory region constraints from the free list of m\+\_\+constr to the m allocator object. After the call, all of allocator m\textquotesingle{}s free address ranges are guaranteed to be within free ranges also found in m\+\_\+constr.


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in,out}}  & {\em m} & The memory allocator object. \\
\hline
\mbox{\texttt{ in}}  & {\em m\+\_\+constr} & A second allocator with new constraints. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Non-\/zero on error. Zero on success. 
