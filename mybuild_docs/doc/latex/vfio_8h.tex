...
\begin{DoxyCompactItemize}
\item 
int \mbox{\hyperlink{vfio_8h_a16353414fd096eb0f5d1623196c4bd0e}{opae\+\_\+vfio\+\_\+dev\+\_\+busy}} (const char $\ast$pciaddr)
\item 
...
\item 
int \mbox{\hyperlink{vfio_8h_a64329daca7f6138b5df0d800ce79676d}{opae\+\_\+vfio\+\_\+apply\+\_\+group\+\_\+constraint}} (struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$new\+\_\+v, struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$v)
\item 
...
\item 
int \mbox{\hyperlink{vfio_8h_a0504a5ae2375dd015b6e1d968a51966f}{opae\+\_\+vfio\+\_\+buffer\+\_\+map}} (struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$v, size\+\_\+t size, uint8\+\_\+t $\ast$buf, uint64\+\_\+t iova)
\item 
int \mbox{\hyperlink{vfio_8h_a6f1d1452b1fb5a60d72b61960f6101cf}{opae\+\_\+vfio\+\_\+buffer\+\_\+unmap}} (struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$v, size\+\_\+t size, uint64\+\_\+t iova)
\item 
...
\mbox{\label{vfio_8h_a16353414fd096eb0f5d1623196c4bd0e}} 
\index{vfio.h@{vfio.h}!opae\_vfio\_dev\_busy@{opae\_vfio\_dev\_busy}}
\index{opae\_vfio\_dev\_busy@{opae\_vfio\_dev\_busy}!vfio.h@{vfio.h}}
\doxysubsubsection{\texorpdfstring{opae\_vfio\_dev\_busy()}{opae\_vfio\_dev\_busy()}}
{\footnotesize\ttfamily int opae\+\_\+vfio\+\_\+dev\+\_\+busy (\begin{DoxyParamCaption}\item[{const char $\ast$}]{pciaddr }\end{DoxyParamCaption})}
...
Example 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if} (opae\_vfio\_dev\_busy(\textcolor{stringliteral}{"{}0000:00:00.0"{}})) \{}
...
\end{DoxyCode}
 \mbox{\label{vfio_8h_a64329daca7f6138b5df0d800ce79676d}} 
\index{vfio.h@{vfio.h}!opae\_vfio\_apply\_group\_constraint@{opae\_vfio\_apply\_group\_constraint}}
\index{opae\_vfio\_apply\_group\_constraint@{opae\_vfio\_apply\_group\_constraint}!vfio.h@{vfio.h}}
\doxysubsubsection{\texorpdfstring{opae\_vfio\_apply\_group\_constraint()}{opae\_vfio\_apply\_group\_constraint()}}
{\footnotesize\ttfamily int opae\+\_\+vfio\+\_\+apply\+\_\+group\+\_\+constraint (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$}]{new\+\_\+v,  }\item[{struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$}]{v }\end{DoxyParamCaption})}

Note a new contraint on the group\textquotesingle{}s IOVA space.
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em new\+\_\+v} & New source of IOVA constraints. \\
\hline
\mbox{\texttt{ in}}  & {\em v} & Apply constraints to this container. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Non-\/zero on error. Zero on success. 
...
\mbox{\texttt{ out}}  & {\em iova} & Optional pointer to receive the IOVA address for the buffer. Pass NULL to ignore. \\
\hline
\mbox{\texttt{ in}}  & {\em flags} & Flags for allocation (e.\+g. OPAE\+\_\+\+VFIO\+\_\+\+BUF\+\_\+\+PREALLOCATED). \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Non-\/zero on error. Zero on success.
...
\end{DoxyCode}
 \mbox{\label{vfio_8h_a0504a5ae2375dd015b6e1d968a51966f}} 
\index{vfio.h@{vfio.h}!opae\_vfio\_buffer\_map@{opae\_vfio\_buffer\_map}}
\index{opae\_vfio\_buffer\_map@{opae\_vfio\_buffer\_map}!vfio.h@{vfio.h}}
\doxysubsubsection{\texorpdfstring{opae\_vfio\_buffer\_map()}{opae\_vfio\_buffer\_map()}}
{\footnotesize\ttfamily int opae\+\_\+vfio\+\_\+buffer\+\_\+map (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$}]{v,  }\item[{size\+\_\+t}]{size,  }\item[{uint8\+\_\+t $\ast$}]{buf,  }\item[{uint64\+\_\+t}]{iova }\end{DoxyParamCaption})}

Map an existing buffer for DMA at iova.

Similar to \mbox{\hyperlink{vfio_8h_a782b8c30e14075d1c69af9c8e2998578}{opae\+\_\+vfio\+\_\+buffer\+\_\+allocate\+\_\+ex()}}, except that the iova is chosen by the caller and the buffer must already be allocated. The OPAE vfio library does not track the iova. It is the caller\textquotesingle{}s responsibility to ensure the iova does not conflict. The caller is also responsible for unmapping with \mbox{\hyperlink{vfio_8h_a6f1d1452b1fb5a60d72b61960f6101cf}{opae\+\_\+vfio\+\_\+buffer\+\_\+unmap()}}.
...
\hline
\mbox{\texttt{ out}}  & {\em buf} & Buffer address. \\
\hline
\mbox{\texttt{ out}}  & {\em iova} & IOVA at which buffer should be mapped. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Non-\/zero on error. Zero on success. 
\end{DoxyReturn}
\mbox{\label{vfio_8h_a6f1d1452b1fb5a60d72b61960f6101cf}} 
\index{vfio.h@{vfio.h}!opae\_vfio\_buffer\_unmap@{opae\_vfio\_buffer\_unmap}}
\index{opae\_vfio\_buffer\_unmap@{opae\_vfio\_buffer\_unmap}!vfio.h@{vfio.h}}
\doxysubsubsection{\texorpdfstring{opae\_vfio\_buffer\_unmap()}{opae\_vfio\_buffer\_unmap()}}
{\footnotesize\ttfamily int opae\+\_\+vfio\+\_\+buffer\+\_\+unmap (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{vfio_8h_structopae__vfio}{opae\+\_\+vfio}} $\ast$}]{v,  }\item[{size\+\_\+t}]{size,  }\item[{uint64\+\_\+t}]{iova }\end{DoxyParamCaption})}

Unmap an existing pinned DMA page.

Undo the effects of \mbox{\hyperlink{vfio_8h_a0504a5ae2375dd015b6e1d968a51966f}{opae\+\_\+vfio\+\_\+buffer\+\_\+map()}}.
...
\mbox{\texttt{ in}}  & {\em size} & Buffer size. \\
\hline
\mbox{\texttt{ out}}  & {\em iova} & IOVA at which buffer should be pinned. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Non-\/zero on error. Zero on success. 
